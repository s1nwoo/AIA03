...
public class ExTestMain {
	...
	public static void main(String[] args) throws UnsupportedEncodingException, NoSuchAlgorithmException, GeneralSecurityException {
		...
		String enStr = sha256.encrypt(str);
		
		System.out.println("평문 : " +str);
		System.out.println("SHA-256암호화: " +enStr);
		...
		// 암호화
		System.out.println("평문: "+str);
		System.out.println("AES-256 암호화 : " + encStr1);
		System.out.println("AES-256 암호화 : " + encStr2);
		
		System.out.println("===========================================");
		
		String plainStr1 = aes256Util.decrypt(encStr1);
		String plainStr2 = aes256Util2.decrypt(encStr2);
		System.out.println("AES-256 복호화 : " +plainStr1);
		System.out.println("AES-256 복호화 : " +plainStr2);
