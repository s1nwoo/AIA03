...
FROM emp
order by sal*12+100 desc, ename asc;
...
from emp
where hiredate BETWEEN '1981-02-20' and '1981-04-30'; 
...
-- 추가문제1) 마당서점의 고객이 요구하는 다음질문에 대해 SQL문을 작성하시오.
...
-- 추가문제2) 마당서점의 운영자와 경영자가 요구하는 다음 질문에 대해 SQL문을 작성하시오.
